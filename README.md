...
<div style="text-align: center; margin-right: 10px;">
    ...
    <img src="https://github.com/KacperDudzik/findmyclothes-API/blob/main/example%20user%20input.png" alt="Project Logo" width="700"/>
</div>

<div style="text-align: center;">
    <strong>EXAMPLE PROGRAM OUTPUT:</strong><br>
    <img src="https://github.com/KacperDudzik/findmyclothes-API/blob/main/example%20program%20output.png" alt="Image 3" width="650"/>
</div>
</div>
